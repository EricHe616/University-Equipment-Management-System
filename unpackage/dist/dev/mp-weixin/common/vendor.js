...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__29FBAB2",
    appName: "高校设备管理信息系统设计",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "172.20.10.14,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_qO-mLf";
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "高校实验设备管理信息系统"
    }
  },
  {
    path: "pages/shangchuan/shangchuan",
    style: {
  ...
  {
    path: "pages/device_detail/device_detail",
    style: {
      navigationBarTitleText: ""
    }
  },
...
const globalStyle = {
  ...
  navigationBarTitleText: "高校实验设备管理信息系统软件设计",
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","172.20.10.14"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","F:/uniapp/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"a123","spaceId":"mp-91eb5c17-fd90-4d5d-98e4-f5508ef90827","clientSecret":"693SkgXryghRxYErhbeUiA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__29FBAB2";
} catch (e2) {
